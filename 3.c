...
int lengthS(unsigned char *string); //uses nul to locate end of string
...
int addLeadingZeros(unsigned char *binaryString, int targetLength) {
    ...
    int currentLength = lengthS(binaryString);
